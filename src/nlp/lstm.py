...
class LSTM(nn.Module):
    def __init__(self, embedding_matrix):
        ...
        # embedding matrix is used as weight of the embedding layer
        ...
        # output layer which is a linear layer we have only one 
        # output, input(512) = 128 + 128 for mean and same for max pooling
